...
class heuristicQueue(Queue):
    ...
    def ordenar(self):
        list.sort(self.lista, key=lambda nodo: nodo.path_cost+self.problem.h(nodo))

    def pop(self):
        return self.lista.pop(0)


class RamificationQueue(Queue):
    """Una cola que tiene en cuenta el coste de los nodos"""
    ...
    def ordenar(self):
        list.sort(self.lista, key=lambda nodo: nodo.path_cost)
